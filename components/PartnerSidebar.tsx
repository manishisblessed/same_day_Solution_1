...
const sidebarItems: SidebarItem[] = [
  ...
  { id: 'bbps', label: 'BBPS-1', icon: Receipt, href: '/dashboard/partner?tab=bbps' },
  { id: 'bbps-2', label: 'BBPS-2', icon: CreditCard, href: '/dashboard/partner?tab=bbps-2' },
  { id: 'credit-card', label: 'Credit Card', icon: CreditCard, href: '/dashboard/partner?tab=credit-card' },
  { id: 'credit-card-2', label: 'Credit Card-2', icon: CreditCard, href: '/dashboard/partner?tab=credit-card-2' },
  { id: 'api-payment', label: 'API Payment', icon: Zap, href: '/dashboard/partner?tab=api-payment' },
  { id: 'payout', label: 'Settlement-1', icon: Banknote, href: '/dashboard/partner?tab=payout' },
