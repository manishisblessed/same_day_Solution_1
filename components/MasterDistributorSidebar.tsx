...
import { 
  ...
  Settings, TrendingUp, Users, Network, Package, X, Menu, Zap
} from 'lucide-react'
...
export default function MasterDistributorSidebar({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  const isActive = (href: string) => {
    if (href === '/dashboard/master-distributor') return pathname === '/dashboard/master-distributor'
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-800">
        <div className="bg-gradient-to-br from-yellow-500/10 to-yellow-600/10 dark:from-yellow-500/20 dark:to-yellow-600/20 rounded-xl p-4 border border-yellow-200/50 dark:border-yellow-800/50">
