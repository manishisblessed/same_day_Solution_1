...
export default function Footer() {
  return (
    <footer className="bg-banking-900 text-gray-300 border-t-4" style={{ borderImage: 'linear-gradient(to right, #f97316, #22c55e) 1' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm mb-4 text-gray-400">
              Fast. Secure. Same-Day Fintech Solutions. Your trusted partner for innovative financial technology services.
            </p>
            ...
            <div className="mt-4">
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-primary-400 transition-colors" aria-label="YouTube">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/partner" className="text-gray-400 hover:text-primary-400 transition-colors">
                  Partner With Us
                </Link>
              </li>
              <li>
                <Link href="/how-it-works" className="text-gray-400 hover:text-primary-400 transition-colors">
                  How It Works
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/terms-of-use" className="text-gray-400 hover:text-primary-400 transition-colors">
                  Terms Of Use
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/grievance" className="text-gray-400 hover:text-primary-400 transition-colors">
                  Grievance Policy
                </Link>
              </li>
              <li>
                <Link href="/compliance" className="text-gray-400 hover:text-primary-400 transition-colors">
                  Compliance
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/business-login" className="text-gray-400 hover:text-primary-400 transition-colors">
                  Business Login
                </Link>
              </li>
            </ul>
