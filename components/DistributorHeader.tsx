...
export default function DistributorHeader() {
  ...
  useEffect(() => {
    const savedDarkMode = localStorage.getItem('distributorDarkMode') === 'true'
  ...
  const toggleDarkMode = () => {
    ...
    localStorage.setItem('distributorDarkMode', String(newDarkMode))
    if (newDarkMode) {
      document.documentElement.classList.add('dark')
    } else {
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex flex-1 max-w-xl mx-8">
            <div className="relative w-full">
              ...
              <input
                type="text"
                placeholder="Search retailers, transactions..."
            ...
            <div className="relative" ref={userMenuRef}>
              ...
              <AnimatePresence>
                {isUserMenuOpen && (
                  ...
                  >
                    <div className="p-4 border-b border-gray-200 dark:border-gray-700">
                      <p className="font-semibold text-gray-900 dark:text-white">{user?.email || 'Distributor User'}</p>
