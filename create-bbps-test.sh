#!/bin/bash
# Script to create BBPS test file on EC2 server
# Run this on your EC2 server: bash create-bbps-test.sh

mkdir -p src/test

cat > src/test/bbps.test.js << 'EOF'
/**
...
chmod +x src/test/bbps.test.js
echo "✅ Created src/test/bbps.test.js"
echo "You can now run: node -r dotenv/config src/test/bbps.test.js"
