  ...
  const services = [
    {
      ...
      description: 'Become a one-stop banking and digital payments centre. Security certified platform for all financial transactions.',
      link: '/services/banking-payments',
    },
    {
      icon: '🏧',
      title: 'Mini-ATM Services',
      description: 'Choose from a wide range of Mini-ATM branded ATMs. Help customers withdraw cash and make merchant payments using cards.',
      link: '/services/mini-atm',
    },
    {
      icon: '👆',
      title: 'AEPS Services',
      description: 'Aadhaar Enabled Payment System for cash withdrawal, balance inquiry, and secure banking transactions using Aadhaar authentication.',
      link: '/services/aeps',
    },
    {
      icon: '💳',
      title: 'Merchant Payments',
      description: 'Enable customers to purchase goods and make payments using Aadhaar card and fingerprint. Secure Aadhaar Pay services.',
      link: '/services/merchant-payments',
    },
    {
      icon: '💸',
      title: 'DMT (Money Transfer)',
      description: 'Domestic Money Transfer services for instant money transfers across India. Support for IMPS, NEFT, RTGS, and UPI.',
      link: '/services/dmt',
    },
    {
      icon: '🚪',
      title: 'Doorstep Banking',
      description: 'BC-Sakhi mobile banking services. Over 3,000 women mobile-retailers providing banking services at customers\' doorsteps.',
      link: '/services/doorstep-banking',
    },
    {
      icon: '📄',
      title: 'Bill Payments',
      description: 'Pay all utility bills including electricity, water, gas, internet, insurance, and credit card bills from one platform.',
      link: '/services/bill-payments',
    },
    {
      icon: '📱',
      title: 'Mobile Recharge',
      description: 'Instant mobile, DTH, and data card recharge services for all major operators. Prepaid and postpaid bill payments.',
      link: '/services/recharge',
    },
    {
      icon: '✈️',
      title: 'Travel Services',
      description: 'Make your shop the travel hub. Offer railway tickets, bus tickets, flight bookings, and hotel reservations.',
      link: '/services/travel',
    },
    {
      icon: '💰',
      title: 'Cash Management',
      description: 'Collect loan installments from customers on behalf of micro-finance companies. Convenient payment solutions.',
      link: '/services/cash-management',
    },
    {
      icon: '🏛️',
      title: 'Government Services',
      description: 'Help customers with PAN card application, income tax filing, GST returns, and other government services.',
