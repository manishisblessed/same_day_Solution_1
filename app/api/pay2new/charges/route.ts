...
/**
 * GET /api/pay2new/charges?amount=1000
 * Get applicable credit card bill payment charges for the current retailer
 */
  ...
  try {
    ...
    try {
      ...
      if (schemeError) {
        ...
        if (chargeError) {
          console.error('[Pay2New Charges] Charge calc error:', chargeError)
