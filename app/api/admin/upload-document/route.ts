...
function getSupabaseClient() {
  ...
  console.log('[Upload Document] NEXT_PUBLIC_SUPABASE_URL:', supabaseUrl ? 'configured' : 'not configured')
  console.log('[Upload Document] SUPABASE_SERVICE_ROLE_KEY:', supabaseServiceKey ? 'configured' : 'not configured')
