...
export const ONBOARD_DOCUMENTS: DocSpec[] = [
  { type: 'SIGNATURE', label: 'Signature', required: false, hint: 'Sign on plain white paper and upload a clear photo/scan.' },
  { type: 'ELECTRICITY_BILL', label: 'Electricity Bill', required: false, hint: 'Latest bill (within 3 months) showing your shop/home address.' },
  { type: 'CANCEL_CHEQUE', label: 'Cancelled Cheque', required: false, hint: 'Cheque of the same bank account you verified; name/IFSC must be visible.' },
  { type: 'ADDITIONAL_ID', label: 'Additional ID (DL / Voter / Passport)', required: false, hint: 'Any one government ID in your name; both sides, clear and readable.' },
  { type: 'FAMILY_REFERENCE', label: 'Family Reference KYC', required: false, hint: 'ID proof of a family member (parent/spouse/sibling) as reference.' },
  { type: 'GPS_PHOTO_OUTSIDE', label: 'Shop Photo (Outside)', required: false, gps: true, hint: 'Live photo of your shop front with signboard visible.' },
  { type: 'GPS_PHOTO_INSIDE', label: 'Shop Photo (Inside)', required: false, gps: true, hint: 'Live photo taken inside your shop.' },
  { type: 'GPS_SELFIE_DISTRIBUTOR', label: 'Selfie at Shop', required: false, gps: true, hint: 'Live selfie of you at your shop.' },
  // Optional
