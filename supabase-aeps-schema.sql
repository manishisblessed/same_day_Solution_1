-- ============================================================================
-- AEPS (AADHAAR ENABLED PAYMENT SYSTEM) SCHEMA
-- ============================================================================
-- Tables for AEPS transactions and merchant management
...
-- ============================================================================
-- Stores all AEPS transactions (balance inquiry, withdrawal, deposit, statement)
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS idx_aeps_transactions_type ON aeps_transactions(transaction_type);
CREATE INDEX IF NOT EXISTS idx_aeps_transactions_created_at ON aeps_transactions(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_aeps_transactions_order_id ON aeps_transactions(order_id);
CREATE INDEX IF NOT EXISTS idx_aeps_transactions_merchant_id ON aeps_transactions(merchant_id);

-- ============================================================================
-- 2. AEPS MERCHANTS TABLE
-- ============================================================================
-- Stores merchant KYC and registration information
-- ============================================================================
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_aeps_merchants_user_id ON aeps_merchants(user_id);
CREATE INDEX IF NOT EXISTS idx_aeps_merchants_merchant_id ON aeps_merchants(merchant_id);
CREATE INDEX IF NOT EXISTS idx_aeps_merchants_mobile ON aeps_merchants(mobile);
CREATE INDEX IF NOT EXISTS idx_aeps_merchants_kyc_status ON aeps_merchants(kyc_status);

-- ============================================================================
-- 3. AEPS BANK LIST TABLE (OPTIONAL - for caching)
-- ============================================================================
-- Cache of supported banks for faster lookups
-- ============================================================================

CREATE TABLE IF NOT EXISTS aeps_banks (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
-- ============================================================================
-- DONE - Run this SQL in your Supabase SQL Editor or PostgreSQL client
-- ============================================================================
